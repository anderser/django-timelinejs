...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimelineEvent.start_time'
        db.add_column('timelinejs_timelineevent', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimelineEvent.end_time'
        db.add_column('timelinejs_timelineevent', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimelineEvent.start_time'
        db.delete_column('timelinejs_timelineevent', 'start_time')

        # Deleting field 'TimelineEvent.end_time'
        db.delete_column('timelinejs_timelineevent', 'end_time')
