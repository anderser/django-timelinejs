...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timeline.start_date'
        db.alter_column('timelinejs_timeline', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Timeline.start_date'
        raise RuntimeError("Cannot reverse this migration. 'Timeline.start_date' and its values cannot be restored.")
